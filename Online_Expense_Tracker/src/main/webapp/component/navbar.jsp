  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <c:if test="${ empty loginUser}">
      ...
      <li class="nav-item">
    		<a class="nav-link active" href="../user/add_expense.jsp">
        	<i class="fa-solid fa-circle-plus"></i> Add Expense</a>
			</li>
        
        	<li class="nav-item">
          	<a class="nav-link active" href="../user/view_expense.jsp" tabindex="-1"><i class="fa-solid fa-list"></i> View Expense</a>
       		</li>
      ...
      <c:if test="${not empty loginUser}">
        	...
        	<i class="fa-solid fa-circle-user"></i> ${loginUser.fullname}</a>
			</li>
       ...
       <c:if test="${empty loginUser}">
        	...
        	<i class="fa fa-right-to-bracket"></i> Login</a>
			</li>
